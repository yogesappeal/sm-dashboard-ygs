    ...
    <div className="flex items-center justify-between px-4 py-2.5 border-t border-slate-100 bg-white">
      ...
      <div className="flex items-center gap-3">
        ...
        <select
          ...
          disabled={isRefreshing}
          className="text-xs border border-slate-200 rounded-lg px-3 py-1.5 bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/30 disabled:opacity-50 cursor-pointer"
        >
          {pages.map((p) => (
