...
# Approve Bill
curl --location 'https://fvpxqvmmasnykwujcaen.supabase.co/functions/v1/bills/c1000000-0000-4000-8000-000000000001/approve' \
--header 'Authorization: Bearer {{bearer}}' \
--header 'Content-Type: application/json' \
--data '{
  "comment": "approve from SM"
}'

# Reject Bill
curl --location 'https://fvpxqvmmasnykwujcaen.supabase.co/functions/v1/bills/c1000000-0000-4000-8000-000000000001/reject' \
--header 'Authorization: Bearer {{bearer}}' \
--header 'Content-Type: application/json' \
--data '{
  "comment": "approve from SM"
